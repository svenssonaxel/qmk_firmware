...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    LOCKDESK,  XXXXXXX,   KC_2,      KC_3,      KC_4,      KC_5,      KC_F1,                               KC_F2,     KC_6,      KC_7,      KC_8,      KC_9,      XXXXXXX,   LOCKDESK,  //
    ...
    KC_F5,     KC_A,      KC_X,      KC_C,      KC_V,      KC_B,      KC_F6,                               KC_F7,     KC_N,      KC_M,      KC_COMMA,  KC_DOT,    SE_OE,     SE_AE,     //
    SE_LESS,   KC_Z,      KC_F11,    KC_F12,    MO(1),                                                                           KC_F13,    KC_F14,    KC_F15,    SE_MINS,   KC_RSHIFT, //
