...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  if (record->event.pressed) {
    switch (keycode) {
    case DOWN10:
      SEND_STRING(SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN) SS_DELAY(100) SS_TAP(X_DOWN));
      break;
    case ENTERUPEND:
      SEND_STRING(SS_TAP(X_ENTER) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_END));
      break;
    case LEFT10:
      SEND_STRING(SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT) SS_DELAY(100) SS_TAP(X_LEFT));
      break;
    case RIGHT10:
      SEND_STRING(SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT) SS_DELAY(100) SS_TAP(X_RIGHT));
      break;
    case SFTEND_BSP:
      SEND_STRING(SS_DOWN(X_LSHIFT) SS_DELAY(100) SS_TAP(X_END) SS_DELAY(100) SS_UP(X_LSHIFT) SS_DELAY(100) SS_TAP(X_BSPACE));
      break;
    case SFTHM_BSP:
      SEND_STRING(SS_DOWN(X_LSHIFT) SS_DELAY(100) SS_TAP(X_HOME) SS_DELAY(100) SS_UP(X_LSHIFT) SS_DELAY(100) SS_TAP(X_BSPACE));
      break;
    case SP_LEFT:
      SEND_STRING(SS_TAP(X_SPACE) SS_DELAY(100) SS_TAP(X_LEFT));
      break;
    case UP10:
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP) SS_DELAY(100) SS_TAP(X_UP));
      break;
    case ALTTAB:
      if(!is_fnlayer_and_altdown) {
        SEND_STRING(SS_DOWN(X_LALT) SS_DELAY(100)); // The corresponding key-up event for left alt is in ensure_fnlayer_alt_up()
